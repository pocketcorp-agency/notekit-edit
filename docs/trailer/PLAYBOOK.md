# AI Inline Edit — trailer playbook & script
...
| 7 | **AI Inline Edit** — *Free in Obsidian community plugins* | "AI Inline Edit. Free, for Obsidian." |
...
### S7 — Outro (3 s)
- **AI Inline Edit** wordmark (kinetic: letters settle in from ±20 px), sub **"Free in Obsidian community plugins"**,
