...
const banner = `/*
AI Inline Edit — Obsidian plugin. Bundled with esbuild; source is in src/.
*/`;
...
const bridge = await esbuild.context({
  ...
  banner: { js: "#!/usr/bin/env node\n/* Claude Code / Codex bridge for the AI Inline Edit Obsidian plugin. Source: src/bridge.ts */" },
  logLevel: "info",
  minify: false,
});
